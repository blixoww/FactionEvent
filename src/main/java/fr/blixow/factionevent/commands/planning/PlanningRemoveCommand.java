                            ...
                            case "koth":
                                ...
                                try {
                                    ...
                                    if (fc.contains(kothPath + "." + koth.getName())) {
                                        ...
                                        player.sendMessage(prefix + new StrManager(msg.getString("planning.not_exist")).reType(args[0]).reKoth(koth.getName()).reTime(valeurJour).toString());
                                        return true;
                                    }

                                    if (!kothList.contains(heure + "h" + minutes)) {
                                        player.sendMessage(prefix + new StrManager(msg.getString("planning.not_exist")).reType(args[0]).reKoth(koth.getName()).reTime(valeurJour + " " + heure + "h" + minutes + "m").toString());
                                        return true;
                                    }

                                    kothList.remove(heure + "h" + minutes);
                                    fc.set(kothPath + "." + koth.getName(), kothList);
                                    fc.save(FileManager.getDataFile("planning.yml"));
                                    player.sendMessage(pPrefix + new StrManager(msg.getString("planning.remove")).reType(args[0]).reKoth(koth.getName()).reTime(valeurJour + " " + heure + "h" + minutes + "m").toString());
                            ...
                            case "totem":
                                ...
                                try {
                                    ...
                                    if (fc.contains(totemPath + "." + totem.getName())) {
                                        ...
                                        player.sendMessage(prefix + new StrManager(msg.getString("planning.not_exist")).reType(args[0]).reTotem(totem.getName()).reTime(valeurJour).toString());
                                        return true;
                                    }

                                    if (!totemList.contains(heure + "h" + minutes)) {
                                        player.sendMessage(prefix + new StrManager(msg.getString("planning.not_exist")).reType(args[0]).reTotem(totem.getName()).reTime(valeurJour + " " + heure + "h" + minutes + "m").toString());
                                        return true;
                                    }

                                    totemList.remove(heure + "h" + minutes);
                                    fc.set(totemPath + "." + totem.getName(), totemList);
                                    fc.save(FileManager.getDataFile("planning.yml"));
                                    player.sendMessage(pPrefix + new StrManager(msg.getString("planning.remove")).reType(args[0]).reTotem(totem.getName()).reTime(valeurJour + " " + heure + "h" + minutes + "m").toString());
                            ...
                            case "dtc":
                                ...
                                try {
                                    ...
                                    if (fc.contains(dtcPath + "." + dtc.getName())) {
                                        ...
                                        player.sendMessage(prefix + new StrManager(msg.getString("planning.not_exist")).reType(args[0]).reDTC(dtc.getName()).reTime(valeurJour).toString());
                                        return true;
                                    }

                                    if (!dtcList.contains(heure + "h" + minutes)) {
                                        player.sendMessage(prefix + new StrManager(msg.getString("planning.not_exist")).reType(args[0]).reDTC(dtc.getName()).reTime(valeurJour + " " + heure + "h" + minutes + "m").toString());
                                        return true;
                                    }

                                    dtcList.remove(heure + "h" + minutes);
                                    fc.set(dtcPath + "." + dtc.getName(), dtcList);
                                    fc.save(FileManager.getDataFile("planning.yml"));
                                    player.sendMessage(pPrefix + new StrManager(msg.getString("planning.remove")).reType(args[0]).reDTC(dtc.getName()).reTime(valeurJour + " " + heure + "h" + minutes + "m").toString());
