...
public class Messages {
    ...
    public static void debugMessages(String message){
        Bukkit.getConsoleSender().sendMessage("§e§lDEBUG:§r " + message);
    }

    public static void debugErrorMessages(String message) {
        Bukkit.getConsoleSender().sendMessage("§e§lERROR:§r §e" + message);
    }

    public static void debugDevMessages(String message){
        for(Player player : Bukkit.getOnlinePlayers()){ debugPlayerMessages(player, message); }
    }

    public static void debugPlayerMessages(Player player, String message){
        if(player.hasPermission("cevent.admin.debug")){
